    ...
    export default {
        textContents: {
            "Training an artificial neural network": [
                ...
                {
                    'method': "During training, the model “learns” the relationship between the input and output data. The model only sees this information as values – it has no idea how the input and output may be physically related.",
                    'flubber_id': 'ANN1',
                    'bees_id': 'step_error'
                },
                {
                ...
                {
                    'method': "The more nodes or hidden layers in the model, the better the model can “learn” complex relationships. To predict stream temperature, we use an ANN with many hidden layers.",
                    'flubber_id': 'ANN6',
                    'bees_id': 'step_error_exp'
                },
                {
                ...
                {
                    'method': "The model compares the predicted value to the observed stream temperature. The difference between the two values represents the error in the prediction.",
                    'flubber_id': 'ANN10',
                    'bees_id': 'step_error_exp'
                },
                {
                    'method': "Since the first set of weights are chosen randomly, the model is pretty far off to begin with.",
                    'flubber_id': 'ANN10',
                    'bees_id': 'step_error_exp'
                },
                {
            ...
            "Testing an artificial neural network (ANN)": [
                ...
                {
                    'method': "Even without training observations, we can guess that streams will be warmest in the summer and that forested headwater streams are cooler than large urban streams.",
                    'flubber_id': '',
                    'bees_id': 'step_ann_exp'
                },
                {
            ...
            "Recurrent neural network (RNN)": [
                ...
                {
                    'method': "For machine learning modeling, incorporating this knowledge is as simple as using models that have memory, allowing information from one day to be passed on to the next.",
                    'flubber_id': '',
                    'bees_id': 'step_ann_exp'
                },
                {
            ...
            "Knowledge-guided deep learning": [
                ...
                {
                    'method': "And the great news? Once the model has learned the general physics of the system, it can do more with less.",
                    'flubber_id': '',
